...
import app.rasendriya.cintamasjid.prays.Method.HighLatMethod;
import app.rasendriya.cintamasjid.prays.Method.MidnightMethod;
 ...
 * <code>
 * {@link app.rasendriya.cintamasjid.prays.PrayTimes} pt = new {@link app.rasendriya.cintamasjid.prays.PrayTimes}({@link Method#ISNA});<br/>
 * pt.adjustMinutes({@link app.rasendriya.cintamasjid.prays.PrayTimes.Time#MAGHRIB}, 1);<br/>
 * pt.adjustAngle({@link app.rasendriya.cintamasjid.prays.PrayTimes.Time#ISHA}, 18);<br/>
 * pt.tuneOffset({@link app.rasendriya.cintamasjid.prays.PrayTimes.Time#FAJR}, 2);<br/>
 * <br/>
 * Map<Time, Double> times = pt.getTimes(new GregorianCalendar(2009, 2, 27), new Location(-6.1744444, 106.8294444, 10));<br/>
 * for ({@link app.rasendriya.cintamasjid.prays.PrayTimes.Time} t : new {@link app.rasendriya.cintamasjid.prays.PrayTimes.Time}[] { {@link app.rasendriya.cintamasjid.prays.PrayTimes.Time#FAJR}, {@link app.rasendriya.cintamasjid.prays.PrayTimes.Time#SUNRISE}, {@link app.rasendriya.cintamasjid.prays.PrayTimes.Time#DHUHR}, {@link app.rasendriya.cintamasjid.prays.PrayTimes.Time#ASR}, {@link app.rasendriya.cintamasjid.prays.PrayTimes.Time#MAGHRIB}, {@link app.rasendriya.cintamasjid.prays.PrayTimes.Time#ISHA} }) { <br/>
...
public class PrayTimes {
	 ...
	 * <ul>
	 * <li>As for {@link app.rasendriya.cintamasjid.prays.PrayTimes.Time#IMSAK}: Minutes before fajr</li>
	 * <li>As for {@link app.rasendriya.cintamasjid.prays.PrayTimes.Time#DHUHR}: Minutes after mid-day</li>
	 * <li>As for {@link app.rasendriya.cintamasjid.prays.PrayTimes.Time#MAGHRIB}: Minutes after sunset</li>
	 * <li>As for {@link app.rasendriya.cintamasjid.prays.PrayTimes.Time#ISHA}: Minutes after maghrib</li>
	 * </ul>
	 *
	 * @param time
	 *            Time to adjust the minutes. The valid times are
	 *            {@link app.rasendriya.cintamasjid.prays.PrayTimes.Time#IMSAK}, {@link app.rasendriya.cintamasjid.prays.PrayTimes.Time#DHUHR}, {@link app.rasendriya.cintamasjid.prays.PrayTimes.Time#MAGHRIB}
	 *            and {@link app.rasendriya.cintamasjid.prays.PrayTimes.Time#ISHA}.
	 * @param minutes
	 *            Minute difference
	 */
	 ...
	 */
	public Map<Time, Double> getTimes(Calendar date, Location location) {
		lat = location.getLat();
		lng = location.getLng();
		elv = location.getElv();
	...
	private Map<Time, Double> clone(Map<Time, Double> times) {
		Map<Time, Double> clone = new HashMap<Time, Double>();
		clone.putAll(times);
