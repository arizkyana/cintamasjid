...
public class PrayTime {
    ...
    public ArrayList<String> waktuSholat(double latitude, double longitude, double timezone){
//        double latitude = -6.9167;
//        double longitude = 107.6000;
////        String uri = "https://maps.googleapis.com/maps/api/timezone/json?location="+latitude+","+longitude+"&timestamp=1331161200&key=AIzaSyD-ktWWAxpahJx_FG5TwDcptP4dK869lbc";
//        double timezone = 7;
